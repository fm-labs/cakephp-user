...
<div id="user-registration-form">
    ...
    <?= $this->Form->input('first_name', ['label' => __d('user','First name'), 'placeholder' => __d('user', 'Firstname')]); ?>
    <?= $this->Form->input('last_name', ['label' => __d('user','Last name'), 'placeholder' => __d('user', 'Lastname')]); ?>
    <?= $this->Form->input('email', ['label' => __d('user','Email'), 'placeholder' => 'email@example.com']); ?>
    <?= $this->Form->input('password1', ['type' => 'password', 'required' => true, 'label' => __d('user','Password'), 'placeholder' => __d('user', 'Min 8 characters')]); ?>
